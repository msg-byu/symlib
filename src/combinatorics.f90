...
!!<summary>Binomial coefficient. Computes the number of permutations of n things, 
!!taken k at a time</summary>
!!<comments author="GLWH" date="June 2014">This implementation was taken from 
!! "Binomial Coefﬁcient Computation: Recursion or Iteration?" by Yannis Manolopoulos, 
!! ACM SIGCSE Bulletin InRoads, Vol.34, No.4, December 2002. 
!! http://delab.csd.auth.gr/papers/SBI02m.pdf 
...
!!</comments>
!!<parameter name="n" regular="true">
!! The total number of items available to choose from.
!!</parameter>
!!<parameter name="k" regular="true">The number of items being chosen each time.</parameter>
...
!**************************************************************************************************
FUNCTION nchoosek_orig(n,k)
integer(li) :: nchoosek_orig
integer, intent(in) :: n,k
