...
public matrix_inverse, determinant, cross_product, volume, norm, reduce_C_in_ABC, &
       ...
       test_two, test_one, test_three, test_four, minkowski_reduce_basis, find_value_in_array
...
!********************************************************************************
! Find a int value inside a 3-dim array
subroutine find_lvalue_in_larray1(array,vals,loc,nfound)
logical, intent(in)     :: array(:)
logical, intent(in)     :: vals(:)
integer, intent(out)    :: loc(:)   ! intent(out), { #found_value }
...
!********************************************************************************
! Find a int value inside a 3-dim array, si version
...
!********************************************************************************
! Find a int value inside a 4-dim array
...
!********************************************************************************
! Find a int value inside a 4-dim array, si version
